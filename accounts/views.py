...
class UserRegisterView(View):
    ...
    def post(self,request):
        ...
        if form.is_valid():
            ...
            messages.success(request,'کد به شما ارسال شد','success')
    ...
    def post(self,request):
        ...
        if form.is_valid():
            ...
            if cd['code']==code_instance.code:
                ...
                user_session['email'],user_session['full_name'],user_session['password'])
                code_instance.delete()
                messages.success(request,'شماثبت نام کردید','success')    
...
class UserLoginView(View):
        ...
        form_template='accounts/login.html'
